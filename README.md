...
(1) install the [Uni3C](https://github.com/alibaba-damo-academy/Uni3C) library and [pytorch3D](https://github.com/facebookresearch/pytorch3d/blob/main/INSTALL.md), then import the path to your installed Uni3C in **uni3c_cam_render_api.py**. eg. sys.path.insert(0, "path of Uni3C-main").
...
Our code is modified based on [VideoX-Fun](https://github.com/aigc-apps/VideoX-Fun/tree/main). We adopt [Wan2.1-Fun-V1.1-1.3B](https://github.com/Wan-Video/Wan2.1) as the base model. We use [Uni3C](https://github.com/alibaba-damo-academy/Uni3C) to generate 3D points. The style of the logo is borrowed from [Helios](https://github.com/PKU-YuanGroup/Helios).
