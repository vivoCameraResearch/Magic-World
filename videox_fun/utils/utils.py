...
def get_video_to_video_render_latent(input_video_path, input_render_mask_path, video_length, sample_size, fps=None, validation_video_mask=None, ref_image=None):
